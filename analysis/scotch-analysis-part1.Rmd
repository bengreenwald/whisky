...
# save html & png versions of the table
gtsave(var_table, here("output", "scotch-part1", "variable-table.html"))
gtsave(var_table, here("output", "scotch-part1", "variable-table.png"))
```
